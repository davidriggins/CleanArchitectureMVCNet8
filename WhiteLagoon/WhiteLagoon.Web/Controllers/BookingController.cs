...
namespace WhiteLagoon.Web.Controllers
{
    public class BookingController : Controller
    {
        ...
        public IActionResult BookingDetails(int bookingId)
        {
            ...
            {
                var availableVillNumber = AssignAvailableVillNumberByVilla(bookingFromDb.VillaId);

                bookingFromDb.VillaNumbers = _unitOfWork.VillaNumber.GetAll(u => u.VillaId == bookingFromDb.VillaId &&
                    availableVillNumber.Any(x => x == u.Villa_Number)).ToList();
            }
        ...
        public IActionResult Checking(Booking booking)
        {
        ...
        private List<int> AssignAvailableVillNumberByVilla(int villaId)
        {
